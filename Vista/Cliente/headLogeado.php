		...
		<div class="container">
			<div class="w3ls_logo_products_left1 text-center">
				<ul class="phone_email">
					<a href="perfil.php"><h4><i class="fa fa-user" aria-hidden="true"></i> Bienvenido, <?php session_start(); echo $_SESSION['nombre'];?></h4></a>
				</ul>
			</div>
			...
			<nav class="navbar navbar-default" >
							...
							<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
								<ul class="nav navbar-nav">
                                    ...
                                    <a href="carrito.php"><i class="fa fa-cart-arrow-down" aria-hidden="true"></i>Mis Productos</a></li>
								</ul>
							</div>
							</nav>
			</div>
