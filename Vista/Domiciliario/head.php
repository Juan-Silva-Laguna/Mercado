			...
			<nav class="navbar navbar-default" >
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav">
						<li><a href="porHacer.php"> Domicilios Para Hacer</a></li>	
						<li><a href="enProceso.php"> Domicilios en Proceso </a></li>	
						<li><a href="realizados.php"> Domicilios Realizados </a></li>
					</ul>
				</div>
				</nav>
			</div>
